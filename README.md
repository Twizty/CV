# Maxim Davydov, Senior Software Engineer

## Education:
Kazan National Research Technological University, 2013-2017, Applied Mathematics and Information Science

## Skills:
- Programming languages: `Scala`, `Rust`, `Haskell`, `Go`, `JavaScript`, `Ruby`, `Python`
- Frameworks: `ZIO`, `Cats`, `Akka`, `Rails`
...
## Experience:
- EPAM _(11.2019 - now)_:
  - .
    - Technologies: `scala`, `zio`, `akka`, `cats`
- eLama _(01.2019 - 10.2019)_:
